...
var CmdCreate = &cobra.Command{
	...
	Example: "olaf create handler user",
...
var CmdCreateService = &cobra.Command{
	...
	Example: "olaf create service user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateRepository = &cobra.Command{
	...
	Example: "olaf create repository user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateModel = &cobra.Command{
	...
	Example: "olaf create model user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
