...
在olaf项目中，我们采用以下mock库来帮助我们编写单元测试
...
完整的源码位于： https://github.com/zxylon/olaf-layout-advanced/blob/main/test/server/handler/user_test.go
...
完整代码位于：https://github.com/zxylon/olaf-layout-advanced/blob/main/test/server/repository/user_test.go
